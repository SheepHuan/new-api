...
const defaultSecuritySettings: SecuritySettings = {
  ...
  RequestQueueDefaultChannelRPM: 0,
  RequestQueueMaxChannelPending: 1000,
  RequestQueueDefaultUserMaxPending: 32,
  RequestQueueScheduleStrategy: 'fifo',
  RequestQueueChannelRPM: '',
  RequestQueueUserMaxPending: '',
